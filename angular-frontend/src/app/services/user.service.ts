...
export class UserService {
    ...
    getUserProducts(sellerId: number): Observable<ProductWithImage[]> {
        return this.httpClient.get<ProductWithImage[]>(this.baseUrl + "/" + sellerId + "/products").pipe(tap(products =>
            products.map(product => this.imageService.createImageInProduct(product)))
        );
    }
